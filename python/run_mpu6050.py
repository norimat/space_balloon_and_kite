...
while 1:
    ...
    print('  t={0:f}'.format(temp)+', Gx={0:f}'.format(gyro_x)+', Gy={0:f}'.format(gyro_y)+', Gz={0:f}'.format(gyro_z)+', Ax={0:f}'.format(accel_x)+', Ay={0:f}'.format(accel_y)+', Az={0:f}'.format(accel_z))
    sleep( 1 )
